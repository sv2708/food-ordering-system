package org.sarav.food.order.service.dataaccess.outbox.payment.adapter;
...
import org.sarav.food.order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import org.sarav.food.order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
...
public class PaymentOutboxRepositoryImpl implements PaymentOutboxRepository {
    ...
    @Override
    public Optional<OrderPaymentOutboxMessage> findByTypeAndSagaIdAndSagaStatusIn(String type,
                                                                                  UUID sagaId,
                                                                                  SagaStatus... sagaStatus) {
