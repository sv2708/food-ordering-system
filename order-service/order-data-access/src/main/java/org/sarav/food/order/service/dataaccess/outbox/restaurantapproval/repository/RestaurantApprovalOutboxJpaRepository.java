package org.sarav.food.order.service.dataaccess.outbox.restaurantapproval.repository;
...
@Repository
public interface RestaurantApprovalOutboxJpaRepository extends JpaRepository<ApprovalOutboxEntity, UUID> {
