...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6263382753292045512L;
...
static {
   ...
   */
  public PaymentRequestAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String customerId, java.lang.String orderId, java.math.BigDecimal price, java.time.Instant createdAt, org.sarav.food.order.OrderPaymentStatus orderPaymentStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 6: return orderPaymentStatus;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: orderPaymentStatus = (org.sarav.food.order.OrderPaymentStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static org.sarav.food.order.PaymentRequestAvroModel.Builder newBuilder() {
    return new org.sarav.food.order.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static org.sarav.food.order.PaymentRequestAvroModel.Builder newBuilder(org.sarav.food.order.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new org.sarav.food.order.PaymentRequestAvroModel.Builder();
    } else {
      return new org.sarav.food.order.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static org.sarav.food.order.PaymentRequestAvroModel.Builder newBuilder(org.sarav.food.order.PaymentRequestAvroModel other) {
    if (other == null) {
      return new org.sarav.food.order.PaymentRequestAvroModel.Builder();
    } else {
      return new org.sarav.food.order.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.sarav.food.order.PaymentRequestAvroModel.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[6], other.orderPaymentStatus)) {
        this.orderPaymentStatus = data().deepCopy(fields()[6].schema(), other.orderPaymentStatus);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.sarav.food.order.PaymentRequestAvroModel other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder setOrderPaymentStatus(org.sarav.food.order.OrderPaymentStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sarav.food.order.PaymentRequestAvroModel.Builder clearOrderPaymentStatus() {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.orderPaymentStatus = fieldSetFlags()[6] ? this.orderPaymentStatus : (org.sarav.food.order.OrderPaymentStatus) defaultValue(fields()[6]);
        return record;
